...
function LeadForm({ t, lang, compact = false, onDone }) {
  ...
  return <form className={`lead-form ${compact ? "compact" : ""}`} onSubmit={submit}>
    ...
    <PremiumSelect label={t.mass} name="mass" placeholder={t.unknown} options={[{value:"",label:t.unknown},{value:"до 300 кг",label:lang === "ru" ? "до 300 кг" : "up to 300 kg"},{value:"300–700 кг",label:"300–700 kg"},{value:"700–1200 кг",label:"700–1200 kg"},{value:"1200–2000 кг",label:"1200–2000 kg"}]} />
    <PremiumSelect label={t.loaders} name="loaders" placeholder={t.unknown} options={[{value:"",label:t.unknown},{value:"Нужны",label:lang === "ru" ? "Нужны" : "Required"},{value:"Не нужны",label:lang === "ru" ? "Не нужны" : "Not required"}]} />
